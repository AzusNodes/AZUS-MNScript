...
wget https://github.com/AzusNodes/AZUS-MNScript/releases/download/v1.0.0/azus-1.0.0-Ubuntu18.04-daemon.tar.gz
...
cd ~/.azus && wget https://github.com/AzusNodes/AZUS-MNScript/releases/download/v1.0.0/bootstrap.zip
